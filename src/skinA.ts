...
import { from, interval, map, switchMap, tap } from "rxjs";
...
class SkinA extends HTMLElement {
   ...
   constructor() {
    ...
    store.query.select().pipe(tap((data: any) => {
     ...
     from(this.setConffetti()).subscribe( (elements:any) => {
       ...
       ws.onmessage = (message) => {
         ...
         if (m.type === 'hashrateupdated' && m.miner === null && m.poolId === 'kaspa1') {
         ...
         if (m.type === 'blockfound' && m.poolId === 'kaspa1') {
  ...
  changePool() {
    ...
    (PoolService.getapi() === 'kaspa1') ? this.navigate('/firo') : this.navigate('/')
  }
  ...
  connectedCallback() {
    ...
    forward.addEventListener('click',  (  ) =>  {
      (PoolService.getapi() === 'kaspa1') ? this.navigate( ' ') : this.navigate( '/firo');

      window.dispatchEvent(new CustomEvent( 'togglePool'));
    });

    (!window.location.pathname.includes('firo')) ? PoolService.setApi('kaspa1') : PoolService.setApi('kaspa1');
    ...
    (PoolService.getapi() === 'kaspa1') ? image.src = 'https://k1pool.com/assets/media/logos/coin-kaspa.png' : image.src = 'https://k1pool.com/assets/media/logos/coin-KAS.png';
   ...
   box-shadow: 9.91px 9.91px 15px #21242d, -9.91px -9.91px 15px rgb(22 25 37);
              ...
              <div class="hero">
                  ...
                  <div class="navigation">
                        <div class="buttons">   
                            <svg class="button-back" id="navBack" width="40" height="40" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#FFF"  stroke-width="1.03" points="13 16 7 10 13 4"></polyline></svg>
                            <svg id="navForward" class="button-fwd"  width="40" height="40" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg"><polyline fill="none" stroke="#FFF"  stroke-width="1.03" points="7 4 13 10 7 16"></polyline></svg></a>
...
<!--              <svg version="1.1" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlns:xlink="https://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">-->
<!--                      <g>-->
<!--                        <g fill="#FFF">-->
...
<!--                    </svg>-->
                  ...
                  <div class="container">
                    ...
                    <div class="cards block" id="ce"></div>
                        ...
                        ${window.location.href.includes('firo') ? 'KAS' : 'KAS'}  
                        <p id="price"></p> USD
